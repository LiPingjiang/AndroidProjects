...
//            listItemView.image.setBackground(context.createPackageContext(NotificationPackages[position], context.CONTEXT_INCLUDE_CODE
//                    | Context.CONTEXT_IGNORE_SECURITY).getDrawable(context.createPackageContext(NotificationPackages[position], context.CONTEXT_INCLUDE_CODE
//                    | Context.CONTEXT_IGNORE_SECURITY).getApplicationInfo().icon));
            //Log.d("listviewadapter_image", "Position: " + position + " ,Icon: " + listNotifications.get(position).icon +","+context.createPackageContext(NotificationPackages[position], context.CONTEXT_INCLUDE_CODE
...
//            ai = null;
//        }
//        listItemView.title.setText((String) (ai != null ? pManager.getApplicationLabel(ai) : "(unknown)"));
